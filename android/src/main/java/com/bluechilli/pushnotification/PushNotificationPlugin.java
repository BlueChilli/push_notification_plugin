...
public class PushNotificationPlugin extends BroadcastReceiver
    ...
    public static void registerWith(Registrar registrar) {
      final MethodChannel channel =
              new MethodChannel(registrar.messenger(), PLUGIN_IDENTIFIER);
    ...
    private void saveToken(Context context, String token) {
      SharedPreferences preferences = context.getSharedPreferences(PUSH_NOTIFICATION_PLUGIN_SHARED_PREFERENCE, MODE_PRIVATE);
